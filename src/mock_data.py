...
def make_mappings(data_dir: Path, df: pd.DataFrame, codes: list[str],
                  teacher_list: list[str], course_list: list[str]) -> None:
    """
    授業とコース、授業と教員の紐づけを行う.
...
if __name__ == '__main__':
    ...
    make_mappings(DATA_DIR, df_lecture, codes, teacher_list, course_list)
    make_constraints(DATA_DIR, df_lecture, df_room, periods)
